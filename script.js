...
function typeWriter() {
  ...
  document.getElementById("js-push").style.width = "65%";
  document.getElementById("js-push").style.transition = "all 1.5s";

  document.getElementById("node-push").style.width = "55%";
  document.getElementById("node-push").style.transition = "all 1.5s";

  document.getElementById("express-push").style.width = "60%";
  document.getElementById("express-push").style.transition = "all 1.5s";

  document.getElementById("socketIo-push").style.width = "75%";
  document.getElementById("socketIo-push").style.transition = "all 1.5s";
}

setInterval(() => {
  document.documentElement.toggleAttribute("switch");
}, 8000)